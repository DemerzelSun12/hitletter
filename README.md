...
HIT Letter是为哈尔滨工业大学三个校区制作的 LaTeX 信纸模板，主要文件是hitletter.cls以及对应的校名图像(没有搞到矢量图，不过清晰度是够的，先凑合用吧)。制作本模板的目的是方便 TeX 用户撰写带有哈工大标志的文档/信件，免去自行设置的繁琐过程，同时尽可能符合学校的相关规定，使生成的文件更加正式、美观。
...
目前的版本还是仿照信纸做的，下一步做一份正式的信件格式，允许自定义邮箱、电话、地址等。
